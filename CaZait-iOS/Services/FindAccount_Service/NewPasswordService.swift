...
class NewPasswordService {
    ...
    static let shared = NewPasswordService()
    ...
    func changeNewPassword(userId: String, password: String, completion : @escaping (NetworkResult<Any>) -> Void) {
        
        let url = "\(APIConstants.newPasswordCangeURL)/\(userId)"
    ...
    private func isVaildData(data: Data) -> NetworkResult<Any> {
        ...
        guard let decodedData = try? decoder.decode(NewPasswordResponse.self, from: data) else { return .pathErr }
