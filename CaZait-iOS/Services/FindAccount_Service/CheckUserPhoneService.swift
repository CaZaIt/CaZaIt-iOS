...
class CheckUserPhoneService {
    ...
    func getCheckUserPhone(phoneNumber: String, isExist: String, completion : @escaping (NetworkResult<Any>) -> Void) {
        
        let url = "\(APIConstants.phonenumberCheckURL)"
    ...
    private func isVaildData(data: Data) -> NetworkResult<Any> {
        ...
        guard let decodedData = try? decoder.decode(UserPhoneCheckResponse.self, from: data) else { return .pathErr }
