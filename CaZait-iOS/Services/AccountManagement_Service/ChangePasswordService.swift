...
class ChangePasswordService {
    ...
    func getChangePasswordInfo(password : String, completion : @escaping (NetworkResult<Any>) -> Void) {
        
        let userId = UserDefaults.standard.string(forKey: "userId")!
        let url = "\(APIConstants.passwordChangeURL)/\(userId)"
    ...
    private func isVaildData(data: Data) -> NetworkResult<Any> {
        ...
        guard let decodedData = try? decoder.decode(ChangePasswordResponse.self, from: data) else { return .pathErr }
    ...
    private func refreshTokenAndRetryRequest(password:String, completion: @escaping (NetworkResult<Any>) -> Void) {
        RefreshTokenService.shared.getRefreshToken() { response in
            ...
            case .success(let data):
                ...
                self.getChangePasswordInfo(password: password, completion: completion)
